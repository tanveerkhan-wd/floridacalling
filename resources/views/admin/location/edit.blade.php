          ...
          <div class="box-header with-border">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <img class="img-thumbnail" src="{{asset('uploads/'.$location->image)}}" style="height: 200px;">
                </div>
              </div>
              @endif
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select class="form-control select2" name="parent_category">
                    ...
                    @foreach($getLocData as $getData)
                      <option value="{{$getData['id']}}" @if($getData['id']==$location->parent_category) selected @endif>{{$getData['name']}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
